...
\begin{thebibliography}{9}
	...
	\bibitem{p1} \emph{Introduction to quantum mechanics}
	\newblock Griffiths, D. J.
	\newblock Upper Saddle River, NJ: Pearson/Prentice Hall, 2005
	
	\bibitem{p2} \emph{Principles of quantum mechanics}
	\newblock Shankar, R
	...
	\bibitem {p12} \emph{Elementary particle physics: An intuitive introduction}
	\newblock Larkoski, A. J.
	\newblock Cambridge University Press, 2019
	
	\bibitem {p13} \emph{Concepts of Elementary Particle Physics}
	\newblock Peskin, M.
	...
	\bibitem {p24} HOOFT, G. '. (2018). Cellular automaton interpretation of quantum mechanics. Place of publication not
